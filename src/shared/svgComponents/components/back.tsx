...
export interface backProps extends React.SVGAttributes<SVGElement> {
size?: string;
}
const back: React.SFC<backProps> = ({size, ...props}) => (
  <svg viewBox="0 0 443.52 443.52" fill="currentColor" width={ size || "1em" } height={ size || "1em" } {...props}>
