...
export interface maleProps extends React.SVGAttributes<SVGElement> {
size?: string;
}
const male: React.SFC<maleProps> = ({size, ...props}) => (
  <svg viewBox="0 0 530 530" fill="currentColor" width={ size || "530" } height={ size || "530" } {...props}>
