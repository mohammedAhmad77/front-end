...
const alert: React.SFC<alertProps> = ({size, ...props}) => (
  <svg viewBox="0 0 512.001 512.001" fill="currentColor" width={ size || "1em" } height={ size || "1em" } {...props}>
    ...
    />
    <path d="M241.001 176.01H270.997V325.99199999999996H241.001zM256 355.99c-11.027 0-19.998 8.971-19.998 19.998s8.971 19.998 19.998 19.998c11.026 0 19.998-8.971 19.998-19.998S267.027 355.99 256 355.99z"
    />
  </svg>
);
